...
public:
    ...
    virtual auto server_metadata() -> std::tuple<call_result, bool> = 0;
    ...
    virtual auto model_metadata(const std::string& model_name, const std::string& model_version) -> std::tuple<call_result, bool> = 0;
