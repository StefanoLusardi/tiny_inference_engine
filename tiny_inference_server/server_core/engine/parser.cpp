...
namespace tie
{
parser::parser() noexcept : _cli{std::make_unique<CLI::App>("tie inference engine")}
{
    spdlog::trace("creating parser");

    _cli->set_version_flag("-v,--version", std::string("tie inference server v0.0.1"));
